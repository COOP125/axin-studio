...
export const COURSE_META: Record<CourseType, CourseMeta> = {
  private: { type: "private", label: "私教器械课", english: "Personal Strength", capacity: 1 },
  student: { type: "student", label: "中高考应试课", english: "Youth Athletic Test Prep", capacity: 3 },
  group: { type: "group", label: "团操课", english: "Dynamic Group Class", capacity: 8 },
  cardio: { type: "cardio", label: "有氧 Cardio", english: "Metabolic Conditioning", capacity: 8 },
};

// 营业时段：10-11, 11-12, [12-13 lunch], 13-14, ..., 19-20
export const HOURS: number[] = [10, 11, 13, 14, 15, 16, 17, 18, 19];

// 每个工作日 (0=周一 … 6=周日) 每小时的课程类型。
// 阿新提前按周排定的固定课表。
